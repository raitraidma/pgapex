...
AJAX&\textit{Asynchronous JavaScript And XML}, asünkroonne JavaScript ja XML. Interaktiivsete veebirakenduste loomise meetod, kus andmevahetus brauseri ja veebiserveri vahel toimub ilma, et oleks vaja kogu lehte uuesti laadida \cite{Vallaste}\\
\end{tabular}
\pagebreak
%----------------------------SISUKORD----------------------------------
\tableofcontents
...
\section{Arendusvahendid ja -protsess}
\subsection{Vagrant}
