...
Käesoleva magistritöö eesmärgiks oli disainida ning realiseerida PostgreSQL andmebaasisüsteemi põhine kiirprogrammeerimiskeskkond, mis võimaldaks luua veebipõhiseid rakendusi. Loodavad rakendused peavad suhtlema andmebaasiga läbi andmebaasiliidese ning rakenduste väljanägemist ning käitumist peab olema võimalik juhtida andmebaasis hoitavate meta-andmetega.\par
Töö käigus uuriti, kuidas saab suhelda väliste andmebaasidega ning kust saab infot vajalike andmebaasiobjektide kohta. Seejärel kirjeldati süsteemi funktsionaalsus, disainiti andmebaas, kasutajaliides ning rakendus.\par
...
\item [Meta-andmed] Andmed andmeelementide kohta, sealhulgas nende andmekirjeldused, ning andmed andmete omanduse, pöördusteede, pääsuõiguste ja muutuvuse kohta \cite{metaAndmed}
\item [Meta-andmetega juhitav] Süsteemi käitumist ja väljanägemist juhitakse andmetega
...
\addcontentsline{toc}{section}{Lisa 5 - Olemi-suhte diagrammid}
