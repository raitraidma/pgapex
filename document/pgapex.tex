...
\begin{LARGE}
PostgreSQL andmebaasisüsteemi põhine meta-andmetega juhitavate veebirakenduste kiirprogrammeerimiskeskkond\\[20pt]
\end{LARGE}
Magistritöö\\[60pt]
\end{center}
...
\subsection*{\centerline{Metadata driven rapid web applications development environment based on PostgreSQL}}
...
\item [Meta-andmed] Andmed andmete kohta
...
\label{lisa1}
\addcontentsline{toc}{section}{Lisa 1 - Populaarsemate litsentside võrdlus}
\begin{table}[H]
\centering
...
\addcontentsline{toc}{section}{Lisa 2 - PostgreSQL andmabaasisüsteemi süsteemikataloogid}
...
\addcontentsline{toc}{section}{Lisa 3 - Free Software}
...
\addcontentsline{toc}{section}{Lisa 4 - Open Source}
