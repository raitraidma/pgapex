...
sshpass -p $SERVER_PASSWORD ssh -o "StrictHostKeyChecking no" -p 22 $SERVER_USER_HOST -P "(PGPASSWORD=$DB_PASSWORD; psql --username=$DB_USER $DB_DATABASE < $DEPLOY_DIR/pgapex/evolutions/5_2_create_app_functions.sql)"
